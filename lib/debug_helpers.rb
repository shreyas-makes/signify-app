...
# Usage in Rails console: DebugHelpers.print_help
...
module DebugHelpers
  ...
  def print_help
    ...
    puts "Commands:"
    puts "  DebugHelpers.check_keystrokes(document_id)  - Check keystroke data for a document"
    puts "  DebugHelpers.latest_document_keystrokes     - Check latest document's keystrokes"
    puts "  DebugHelpers.user_keystroke_summary(user_id) - Summary of user's keystroke data"
  end
end
